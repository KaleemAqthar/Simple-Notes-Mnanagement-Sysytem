...
CREATE TABLE `filesdata` (
  ...
  PRIMARY KEY (`fileid`),
  KEY `userid` (`userid`),
  CONSTRAINT `filesdata_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `usersdata` (`userid`)
...
CREATE TABLE `notesdata` (
  ...
  PRIMARY KEY (`notesid`),
  KEY `userid` (`userid`),
  CONSTRAINT `notesdata_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `usersdata` (`userid`)
...
INSERT INTO `notesdata` VALUES (1,'python Basics','            varibles ,functions,loops,contitions, file handlings,opps','2026-06-16 11:59:50',1);
...
INSERT INTO `usersdata` VALUES (1,'kaleem','kaleemaqther@gmail.com','Kaleem@4352'),(2,'aqthar','svppcai@gmail.com','12345');
...
-- Dump completed on 2026-06-21 15:28:08
